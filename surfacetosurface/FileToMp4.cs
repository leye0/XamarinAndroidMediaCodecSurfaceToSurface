...
namespace MediaCodecHelper {
	...
	public class FileToMp4  {
		...
		public FileToMp4(Context context, int fps, int secondPerIFrame, Size? outputSize, int bitRate = 6000000) {
			_context = context;
		...
		private void prepareMediaPlayer() {
			...
			_mediaPlayer.SetDataSource (Path.Combine (_workingDirectory, "cat2.mp4"));
